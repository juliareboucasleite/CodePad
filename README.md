...
Para rodar pelo Maven, use mvnw javafx:run com JAVA_HOME apontando para um JDK 21+. Para gerar o instalador Windows, use `package-release.ps1` (ou `package-installer.ps1`) com JDK 21 no JAVA_HOME. Anexe na release do GitHub: `dist/CodePad.exe` e opcionalmente `dist/installer/CodePad-x.y.z.exe`.
